...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 8.5822; // in; distance between the left and right wheels
    public static double FORWARD_OFFSET = 0; // in; offset of the lateral wheel

    public static double xMulti=0.95752,yMulti=0.99125;//
    ...
    public List<Double> getWheelPositions() {
        ...
        return Arrays.asList(
                encoderTicksToInches(leftPos)*xMulti,
                encoderTicksToInches(rightPos)*xMulti,
                encoderTicksToInches(frontPos)*yMulti
        );
    }
    ...
    public List<Double> getWheelVelocities() {
        ...
        return Arrays.asList(
                encoderTicksToInches(leftVel)*xMulti,
                encoderTicksToInches(rightVel)*xMulti,
                encoderTicksToInches(frontVel)*yMulti
        );
    }
}
