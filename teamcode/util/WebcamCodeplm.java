...
//    }
    ...
    class Pipeline extends OpenCvPipeline
    {
        ...
        Rect LEFT_ROI = new Rect(new Point(150, 670), new Point(300, 750));

        Rect CENTER_ROI = new Rect(new Point(900, 660), new Point(1150, 720));
        Rect RIGHT_ROI = new Rect(new Point(1650, 600), new Point(1800, 750));
